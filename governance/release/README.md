...
5. Start `.github/workflows/publish.yml` manually from the `release` environment only after approval. `tooling/release/publish.mjs` fails closed unless the environment flag and an npm token are present, and it refuses private packages.
